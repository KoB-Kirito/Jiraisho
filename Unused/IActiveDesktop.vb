...
'        VALIDSTATEBITS = NORMAL Or SPLIT Or FULLSCREEN
'    End Enum
...
'        RESTORED_CSI = &H2000
'        CURITEMSTATE = &H4000
'        ALL = TYPE Or CHECKED Or DIRTY Or NOSCROLL Or POS_LEFT Or SIZE_WIDTH Or SIZE_HEIGHT Or POS_ZINDEX Or SOURCE Or FRIENDLYNAME Or POS_TOP Or SUBSCRIBEDURL Or ORIGINAL_CSI Or RESTORED_CSI Or CURITEMSTATE
'    End Enum
